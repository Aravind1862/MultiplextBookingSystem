...
//			UsersDto newUser = new UsersDto(user.getUserId(),user.getFirstName(),user.getLastName(),user.getGender(),user.getEmail());
	...
	public Users updateUserById(int userId,Users existingUser) throws IdNotFoundException,InvalidPasswordException,InvalidNameException,InvalidGenderException
	{
...
//			}
	...
	public String resetUserPassword(int userId, UsersDto userDto) {
		// TODO Auto-generated method stub
		return null;
	}
